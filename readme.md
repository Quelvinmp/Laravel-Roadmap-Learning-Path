...
| Route Groups ✅|:book: [Route Groups](https://laravel.com/docs/routing#route-groups) ✅<br> :clapper: [Laravel Route Grouping: Simple to Very Complex](https://www.youtube.com/watch?v=I6kyfSmPhn8)✅ <br> :clapper: [More videos](videos/route-groups.md) ✅<br> :clapper: [Optional - "Cruddy by Design" - Adam Wathan - Laracon US 2017](https://www.youtube.com/watch?v=MF0jFKvS4SI)⛔|
